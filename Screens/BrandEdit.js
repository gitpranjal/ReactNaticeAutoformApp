...
class BrandEdit extends React.Component {
  ...
  submit = () => {
    ...
    if (checkflag === 0) {
      fetch(
        "https://qualitylite.bluekaktus.com/api/bkQuality/masters/PostBrandDetails",
        {
          method: "POST",
          body: JSON.stringify({
            basicparams: {
...
BrandEdit.navigationOptions = (navData) => {
  return {
