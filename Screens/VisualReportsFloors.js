...
class VisualReportsFloors extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      loading: false,
      ...
      floor:props.navigation.state.params.floor,
      FromDatex:null,
      floors:[],
      pcsprod:[],
      pcsstitched:[],
    ...
    console.log(
      JSON.stringify({
        ...
        reportParams:{
          ...
          dateRange:"",
          locationID: this.state.selectedfloorid,
          locationLevel:"FLOOR"
        }
      })
    )
  ...
  getData=(daterange)=>{
    ...
    var Floors=[]
    this.state.floor.forEach(function (item, index) {
        Floors.push({label:item.val,value:item.id})
      });
      this.setState({
          floors:Floors,
          selectedfloor:Floors[0].label,
          selectedfloorid:Floors[0].value
      },()=>{
        ...
        <View style={{flex:1}}>
            ...
            <DropDownPicker
                ...
                <DropDownPicker
                        ...
                        placeholder={this.state.selectedfloor}
...
VisualReportsFloors.navigationOptions = (navData) => {
  return {
    headerTitle: "Reports",
    headerStyle: {
...
export default VisualReportsFloors;
