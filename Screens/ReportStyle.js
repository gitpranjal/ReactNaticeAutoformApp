...
class ReportStyle extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      loading: true,
        ...
        <ScrollView>
          ...
          <DropDownPicker
                  ...
                  />
                    ...
                    <Text style={{marginLeft:25,fontSize:15,fontWeight:"bold",color:Colors.primaryColor}}>**Data Across ALL LINES</Text>
...
ReportStyle.navigationOptions = (navData) => {
    return {
        headerTitle: "Reports",
        headerStyle: {
