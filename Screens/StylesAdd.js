...
class StylesAdd extends React.Component {
  ...
  contourgen1=(urix)=>{
    ...
    fetch(
      ...
      .catch((error) => {
        console.log(error)
        Alert.alert("An error has occured!!","This seems to be a server issue. Pls wait and try again later...")}); //to catch the errors if any
  }
  ...
  contourgen2=(urix)=>{
   ...
   this.setState({
    ...
    fetch(
      ...
      .catch((error) => {
        Alert.alert("An error has occured!!","This seems to be a server issue. Pls wait and try again later...");
