...
class VisualReportsFactory extends React.Component {
  constructor(props) {
    super(props);
    console.log(props)
    this.state = {
      ...
      factory:props.navigation.state.params.factory,
      FromDatex:null,
      pcsprod:[],
      pcsstitched:[],
      pcsalter:[],
    ...
    console.log(
      JSON.stringify({
        ...
        reportParams:{
          ...
          dateRange:"",
          locationID: this.state.selectedfactoryid,
  ...
  getData=(daterange)=>{
    ...
    var Factories=[]
    this.state.factory.forEach(function (item, index) {
        Factories.push({label:item.val,value:item.id})
      });
      this.setState({
          factories:Factories,
          selectedfactory:Factories[0].label,
          selectedfactoryid:Factories[0].value
      },()=>{
      ...
      return (
        <View style={{flex:1}}>
            ...
            <DropDownPicker
                ...
                />
                <DropDownPicker
                        items={this.state.factories}
                        placeholder={this.state.selectedfactory}
...
VisualReportsFactory.navigationOptions = (navData) => {
  return {
    headerTitle: "Reports",
    headerStyle: {
...
export default VisualReportsFactory;
